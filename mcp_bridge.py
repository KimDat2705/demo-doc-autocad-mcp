...
SYSTEM_PROMPT = (
    ...
    "    ↳ CAO ĐỘ THẤP/SÂU NHẤT hoặc CAO NHẤT (đáy móng, đỉnh mái...) -> GỌI cao_do_min_max (KHÁC thong_tin_tang "
    "dùng cho chiều-cao-TẦNG). Trình bày cao_do_thap_nhat_m / cao_do_cao_nhat_m + trích nguyên_văn + handle của "
    "'thap_nhat'/'cao_nhat'. ⛔ ĐỪNG lấy số trong 'canh_bao' (marker layer thép ĐÃ bị loại, không phải cao độ). "
