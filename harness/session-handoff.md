...
> **⏭ CÒN LẠI: chỉ còn B7** (red-team vòng 2 sau tích hợp, ≥5 file kích-hoạt-mới, **BẮT BUỘC** — `[[feedback-red-team-2-tang]]`). Sau khi #37 LIVE: lát **grounding-có-đơn-vị** (lỗ ×1000 ở `mcp_bridge`) — user đã chốt xếp NGAY SAU.
