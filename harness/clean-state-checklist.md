...
- [ ] `grep -c "@mcp.tool" mcp_server.py` = **26** (23 + `hoc_quy_uoc` + `thu_hoi_quy_uoc` [P3, LOẠI khỏi gemini_tools = R8] + `cao_do_min_max` [id135-recall])
...
- [ ] `bash harness/scripts/check.sh` = **HARNESS GATE: PASS** (**20 bước**: import+26tool · no-key · takeoff 258 · fallback 22 · size 9 · ttl 12 · session 25 · health 11 · hoc-log 20 · hoc-quy-uoc 2 · visual 15 · excel 17 · misc 84 · vntext 28 · fuzz 36 · dwgconv 10 · mcp-stdio 14 · app-routes 8 · grounding-guard 32 · cao-do 12)
