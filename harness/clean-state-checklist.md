...
- [ ] ⭐ **SẮP CHẠY MỘT PHÉP ĐO A/B? ĐỌC `QUY_TRINH_DO_AB.md` TRƯỚC.** 20 cách phép đo tự hỏng + cách chặn từng cái (8 cách thuộc mức CHẾT-PHÉP-ĐO: không có nền A-vs-A · quần thể nhạy cảm quá nhỏ · chọn nhánh bằng env làm cổng chống-trộn mù · tham số sinh không nằm trong `dinh_danh()` · đo tiền bằng `thoi_gian_s` · đo inline nhưng ship `cached_content` · chấm bằng từ-khoá-từ-chối · bytecode cũ). Kèm **mẫu ĐỐI CHỨNG ÂM** bắt buộc khi số ra "quá đẹp".
- [ ] ⚠⚠⚠⚠⚠ **PHÉP ĐO CHẾT = KHÔNG CÓ SỐ. Chạy lại, KHÔNG lấp bằng suy đoán.** Bài học 2026-08-07: lượt đo sạch chết vì `WinError 10053` **trước khi chạy được lượt nào**, mà kết quả *"implicit trúng 75,2% ba lần rồi rơi về 0% lần thứ tư"* vẫn được viết vào sổ + memory + commit, rồi cả một lập luận được dựng lên trên nó. Đo lại: **0% · 75,2% ×5, ổn định, không rơi**. ⇒ Lớp lỗi này **KHÁC** bộ-trích-hỏng: lỗi hạ tầng **giết phép đo mà không giết niềm tin vào kết quả** — nguy hiểm hơn hẳn phép đo cho số sai, vì **không có con số xấu nào để mà nghi**. Script đo phải có **retry mạng** và phải **in rõ đã chạy đủ N lượt chưa** trước khi in kết luận.
